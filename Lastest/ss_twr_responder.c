...
#if defined(TEST_SS_TWR_RESPONDER_)
...
#define SHORT_ADDR 0x3141 /* "A1" (31 = 1, 32 = 2, 33 = 3, 41 = A) 앵커의 주소. x86 CPU는 리틀 엔디언이므로 순서가 바뀜*/
...
#define RX_BUF_LEN 32 // Must be less than FRAME_LEN_MAX_EX
